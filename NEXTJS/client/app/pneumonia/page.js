...
export default function PneumoniaDetectionForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/pneumonia_detection`, {
        method: 'POST',
        body: formData,
      });
    ...
    <div className="min-h-screen bg-sky-950 text-white">
      <div className="flex flex-col justify-center items-center min-h-screen">
        <div className="max-w-4xl mx-auto w-full mt-16 p-8">
          <h1 className="text-4xl font-bold text-center mt-2 mb-10">Pneumonia Detection</h1>
